package com.jomolangma.app.performance.ch4.threadpool.simple;
...
public class TestThreadPool {
	...
	public void testJDKThreadPool() throws InterruptedException {
		...
		System.out.println("newCachedThreadPool size:"
	...
	public void testNoThreadPool() throws InterruptedException {
		long starttime = System.currentTimeMillis();
		for (int i = 0; i < 1000; i++) {
			new Thread(new MyThread("testNoThreadPool" + Integer.toString(i)))
					.start();
		}
		System.out.println();
		long endtime = System.currentTimeMillis();
